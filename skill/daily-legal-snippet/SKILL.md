...
description: "Guía de formato de Quipu Advisors para redactar novedades legislativas y regulatorias diarias (snippets): proyectos de ley y su tramitación en jurisdicciones argentinas —Congreso de la Nación, Cámara de Diputados, Senado y legislaturas provinciales— y en otros países de la región (Chile, Uruguay, Paraguay y otros), y también normas ya vigentes del Poder Ejecutivo publicadas en el Boletín Oficial (decretos, resoluciones, disposiciones), de Argentina o de la región. Usá esta skill SIEMPRE que el usuario pida armar el snippet del día, el snippet de una jurisdicción, o cuando pegue/adjunte información de proyectos presentados, giros a comisión, órdenes del día, dictámenes, media sanción, sanción, observaciones, publicación en el Boletín Oficial de una ley, o normas del Poder Ejecutivo (decretos/resoluciones/disposiciones) y quiera redactarlos en el formato de Quipu. Usala también cuando el usuario pegue o adjunte el mail diario del Boletín Oficial (una lista sin organizar de normas) y pida clasificarlo por sector para sumarlo al snippet. Usala aunque el usuario no diga la palabra 'snippet': si el pedido es convertir movimientos parlamentarios o normas del BO en texto redactado para clientes, corresponde esta skill. Esta skill produce el snippet redactado para clientes, en texto/markdown: NO la uses cuando el pedido sea armar mensajes para WhatsApp (comentario-ley-quipu u otra skill de WhatsApp), ni para convertir el snippet ya redactado a JSON para la app Snippet Digital (para eso existe `snippet-digital-json`)."
---
